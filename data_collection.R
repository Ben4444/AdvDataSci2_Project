...
decisions$opinion[decisions$case == "Furman v. Georgia"] <- "Stewart"
decisions$opinion[decisions$case == "Jurek v. Texas"] <- "Stewart"
decisions$opinion[decisions$case == "Gomez v. United States District Court for the Northern District of California"] <- "Stewart"
...
decisions$opinion[decisions$case == "Buckley v. Valeo"] <- "Brennan"
